...
if this_module == main_module:
    ...
    utils.request_search( db='nucleotide',
                          term='coronavirus',
                          retmax=3, #solo cogemos los 3 primeros
    ...
    utils.print_in_color(utils.get_pretty_str(search_content))
    ...
    #SeqIO read llegeix un fasta. parse llegeix varis multifasta
