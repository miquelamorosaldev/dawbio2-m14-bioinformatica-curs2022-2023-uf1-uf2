...
def esearch():
    ...
    with Entrez.esearch(db="nucleotide", term="opuntia[Organism]", idtype="acc") as response:
        res = Entrez.read(response)
    ...
    with Entrez.esearch(db="nucleotide", term="opuntia[Organism]", rettype="count") as response:
