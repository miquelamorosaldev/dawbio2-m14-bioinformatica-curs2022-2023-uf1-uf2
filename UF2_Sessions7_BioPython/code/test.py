...
def chapter_4_cannabis_genbank_part2():
    ...
    ## Agafem l'intèrval d'ADN del CDS.
    startCDS : int = last_cds.location.start
    endCDS : int = last_cds.location.end
    ...
    fasta_sars_cov_2_SEQ = Seq(fasta_sars_cov_2.seq[startCDS:endCDS])
